...
Deno.test("first three GLASBEY_COLORS are RGB", () => {
  assertEquals(GLASBEY_COLORS[0], "FF0000"); // Red
  assertEquals(GLASBEY_COLORS[1], "00FF00"); // Green
  assertEquals(GLASBEY_COLORS[2], "0000FF"); // Blue
});
