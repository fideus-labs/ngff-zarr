...
class TestUnsupportedOutput:
    ...
    def test_unsupported_nii_output(self, input_images):  # noqa: ARG002
        """Test that .nii output is rejected with informative error."""
        input_path = str(test_data_dir / "input" / "cthead1.png")
        result = _run_ngff_zarr("-i", input_path, "-o", "output.nii")
        assert result.returncode == 1
