...
class TestIdentityDirection:
    ...
    def test_3d_identity(self):
        ...
        assert ngff.axes_orientations["x"].value == AnatomicalOrientationValues.right_to_left
        assert ngff.axes_orientations["y"].value == AnatomicalOrientationValues.anterior_to_posterior
        assert ngff.axes_orientations["z"].value == AnatomicalOrientationValues.inferior_to_superior
...
class TestPermutedAxes:
    ...
    def test_3d_permuted_xyz_to_yzx(self):
        ...
        assert ngff.axes_orientations["x"].value == AnatomicalOrientationValues.anterior_to_posterior
        # y (ITK axis 1) → column 1 → [0, 0, 1] → Z dominant → I/S
        assert ngff.axes_orientations["y"].value == AnatomicalOrientationValues.inferior_to_superior
        # z (ITK axis 2) → column 2 → [1, 0, 0] → X dominant → R/L
        assert ngff.axes_orientations["z"].value == AnatomicalOrientationValues.right_to_left
    ...
    def test_3d_flipped_y(self):
        ...
        assert ngff.axes_orientations["x"].value == AnatomicalOrientationValues.right_to_left
        assert ngff.axes_orientations["y"].value == AnatomicalOrientationValues.posterior_to_anterior
        assert ngff.axes_orientations["z"].value == AnatomicalOrientationValues.inferior_to_superior
    ...
    def test_2d_swapped_xy(self):
        ...
        assert ngff.dims == ("y", "x")
        assert ngff.axes_orientations["x"].value == AnatomicalOrientationValues.anterior_to_posterior
        assert ngff.axes_orientations["y"].value == AnatomicalOrientationValues.right_to_left
...
class TestObliqueDirection:
    ...
    def test_3d_45_degree_rotation_xy(self):
        ...
        assert ngff.axes_orientations["y"].value == AnatomicalOrientationValues.left_to_right
